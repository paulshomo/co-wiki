...
Karpathy's LLM Knowledge Base is composed of the Obsidian front end and visualizations, command line tools, the Obsidian Vault wiki, and would require Git for versioning.

The Co-Wiki is a wiki like DokuWiki and an LLM enabled with mutual filesystem access. For reading and searching no infrastructure or API integration is even needed.
